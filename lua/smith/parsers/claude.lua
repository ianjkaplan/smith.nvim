---@class SmithClaudeParser
---@field state SmithClaudeParserState
local M = {}

---@class SmithClaudeParserState
...
---@alias TypeHandler fun(data: table, result: SmithClaudeParseResult): nil
...
---@param stream_state SmithClaudeStreamState
...
---@alias StreamUpdateHandler fun(stream_state: SmithClaudeStreamState, result: SmithClaudeParseResult): nil
...
---@param result SmithClaudeParseResult
---@return string
...
---@param stream_state SmithClaudeStreamState
---@param line string
---@return SmithClaudeStreamState, boolean
